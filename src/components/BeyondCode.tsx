...
// 🚀 OPTIMIZATION: Extract static data outside component
const hobbies = [
  { 
    icon: Camera, 
    title: "Photography", 
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-24 border-t border-base-300/50 mt-10">
      <div className="text-center mb-16">
        <h3 className="text-4xl font-bold text-base-content tracking-tight">Beyond the Code</h3>
        <p className="text-lg text-base-content/60 mt-2">What I'm doing when I'm not staring at a screen.</p>
      </div>
      ...
      >
        {hobbies.map((hobby, i) => (
          ...
          >
            ...
            <h4 className="text-2xl font-bold text-base-content mb-3">{hobby.title}</h4>
