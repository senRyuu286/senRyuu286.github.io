...
export default function Footer() {
  return (
    <footer className="bg-base-200 px-6 py-20 overflow-hidden">
      ...
      >
        <m.div variants={topVariants} className="mb-12 transform-gpu will-change-transform">
        ...
        <m.div
          ...
          className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transform-gpu will-change-transform"
        >
          ...
          <div className="flex items-center gap-5 text-base-content/60 md:ml-auto">
            <a
              ...
              className="hover:text-primary transition-all duration-300 hover:-translate-y-1 transform-gpu will-change-transform"
            >
              <Linkedin size={20} />
            </a>
            <a
        ...
        <m.div
          ...
          className="mt-12 flex flex-col items-center gap-4 transform-gpu will-change-transform"
        >
          <button
            onClick={() => {
              document
