...
import { Monitor, Terminal, Smartphone } from "lucide-react"; // 🔥 Removed unused Code2
...
// 🔥 Added : Variants to explicitly tell TypeScript how to read these objects
...
export default function BentoStack() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-24">
      <div className="mb-12">
        <h3 className="text-4xl font-bold text-base-content tracking-tight">Tech Stack</h3>
        <p className="text-lg text-base-content/60 mt-2">Technologies and languages I'm actively building with.</p>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="card-body z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="card-title text-2xl text-base-content">Web Development</h4>
            </div>
            <p className="text-base-content/70 mb-6">Building responsive, interactive, and performant user interfaces.</p>
        ...
        >
          ...
          <div className="card-body z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-bold text-lg text-base-content">Software & Scripts</h4>
            </div>
            <div className="flex flex-wrap gap-2">
              {techCategories.software.map((tech) => (
                <span key={tech} className="badge badge-lg bg-base-100 border-none text-base-content/80 group-hover:text-base-content transition-colors">
                  {tech}
                </span>
              ))}
            </div>
        ...
        >
          <div className="card-body z-10 justify-center items-center text-center">
            ...
            <h4 className="font-bold text-lg text-base-content mb-1">Mobile Apps</h4>
            <div className="flex flex-wrap gap-2 justify-center">
              {techCategories.mobile.map((tech) => (
                <span key={tech} className="text-primary font-bold tracking-wide">
                  {tech}
                </span>
              ))}
            </div>
